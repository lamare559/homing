            ...
            <div class="sigin" style={{
                ...
                <div className="mx-auto my-5 col-lg-4 col-md-6 col-sm-4">
                    <div className="card-body">
                        <h1 className="card-title text-center signin-title">Sign In - Agent</h1>
                        <div className="d-flex d-sm-flex flex-column justify-content-center">
                            <form className="form mx-4">
                                ...
                                <p>Don't have an account? <Link className="signup-link" to="/agent-signup">Sign Up</Link></p>
                                <p className="p-proprietor">Are you a proprietor? <Link className="signup-link-proprietor" to="/proprietor-signup">Sign Up</Link></p>
