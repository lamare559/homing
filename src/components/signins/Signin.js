            ...
            <div class="sigin" style={{
                ...
                <div className="mx-auto my-5 col-lg-4 col-md-6 col-sm-4">
                    <div className="card-body">
                        <h1 className="card-title text-center signin-title">
                            Sign In - Searcher
                        </h1>
                        <div
                            className="d-flex d-sm-flex flex-column justify-content-center"
                        >
                            <form className="form mx-4">
                                ...
                                <button
                                    type="submit"
                                    onClick={onSignin}
                                    className="btn-signin btn-block"
                                >
                                    Signin
                                </button>
                                <Link
