    ...
    const signinWithFacebook = () => {
        ...
        app.auth().signInWithPopup(provider).then(async (userId) => {
            if(app.auth().currentUser) {
                ...
                if(userId) {
                    await app.firestore().doc('agents/' + userId).set({
                        status: "agent",
                        displayName,
                        photoURL,
                        phone,
            ...
            <div className="signup" style={{
                ...
                <div className="mx-auto my-5 col-lg-4 col-md-6 col-sm-4">
                    <div className="card-body">
                        <h1 className="card-title text-center signup-title">Sign Up - Agent</h1>
                        <div className="d-flex d-sm-flex flex-column justify-content-center">
                            <form className="form mx-4">
                                ...
                                <p>Already have an account? <Link className="signup-link" to="/agent-signin">Sign In</Link></p>
                                <p className="p-proprietor">Or are you a proprietor? <Link className="signup-link-proprietor" to="/proprietor-signup">Sign Up</Link></p>
