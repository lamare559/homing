    ...
    const signinWithFacebook = () => {
        ...
        app.auth().signInWithPopup(provider).then(async (userId) => {
            if(app.auth().currentUser) {
                ...
                if(userId) {
                    await app.firestore().doc('searchers/' + userId).set({
                        status: "searcher",
                        displayName,
                        photoURL,
                        phone,
            ...
            <div className="signup" style={{
                ...
                <div className="mx-auto my-5 col-lg-4 col-md-6 col-sm-4">
                    <div className="card-body">
                        <h1 className="card-title text-center signup-title">Sign Up - Searcher</h1>
                        <div className="d-flex d-sm-flex flex-column justify-content-center">
                            <form className="form mx-4">
                                ...
                                <p className="p-agent">Are you an agent? <Link className="signup-link" to="/agent-signup">Sign Up</Link></p>
                                <p className="p-proprietor">Are you a proprietor? <Link className="signup-link" to="/proprietor-signup">Sign Up</Link></p>
